...
export default {
  ...
  computed: {
    ...
    selectStyle () {
      ...
      return {
        backgroundColor: this.$themes.darkBackground,
        borderColor: (this.isKeyboardFocused ||this.hoverState ) ? this.$themes.primary : this.$themes.background,
      }
    },
    optionsListStyle () {
      return { maxHeight: this.maxHeight, backgroundColor: this.$themes.darkBackground, }
    },
    displayedText () {
      if (!this.valueProxy) {
        return ''
