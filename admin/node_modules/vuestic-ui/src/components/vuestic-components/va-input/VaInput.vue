    ...
    >
      ...
      >
        ...
        <input
          v-else
          class="va-input__container__input"
          :style="{ paddingBottom: label ? '0.125rem' : '0.875rem', color: this.$themes.brightForeground }"
          :aria-label="label"
          :type="type"
          :placeholder="placeholder"
          :disabled="disabled"
...
export default {
  ...
  computed: {
    iconStyles () {
      ...
      return { color: this.$themes.foreground }
    },
    labelStyle () {
      ...
      return {
        backgroundColor:
          this.error ? getHoverColor(this.$themes['danger'])
            : this.success ? getHoverColor(this.$themes['success']) : this.$themes.darkBackground,
        borderColor:
          this.error ? this.$themes.danger
            : this.success ? this.$themes.success
              : this.isFocused ? this.$themes.foreground : this.$themes.background,
      }
    },
    textareaStyles () {
      return {
